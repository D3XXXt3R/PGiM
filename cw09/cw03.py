...
kernel_miss_1_1 = np.array([[1, 1, 1],
                            [0, 0, 0],
                            [0, 0, 0]], dtype=np.uint8)
kernel_hit_1_2 = np.array([[1, 0, 0],
                           [1, 1, 0],
                           [1, 0, 0]], dtype=np.uint8)
kernel_miss_1_2 = np.array([[0, 0, 1],
                            [0, 0, 1],
                            [0, 0, 1]], dtype=np.uint8)
kernel_hit_1_3 = np.array([[1, 1, 1],
                           [0, 1, 0],
                           [0, 0, 0]], dtype=np.uint8)
kernel_miss_1_3 = np.array([[0, 0, 0],
                            [0, 0, 0],
                            [1, 1, 1]], dtype=np.uint8)
kernel_hit_1_4 = np.array([[0, 0, 1],
                           [0, 1, 1],
                           [0, 0, 1]], dtype=np.uint8)
kernel_miss_1_4 = np.array([[1, 0, 0],
                            [1, 0, 0],
                            [1, 0, 0]], dtype=np.uint8)
kernel_hit_2_1 = np.array([[0, 0, 0],
                           [1, 1, 0],
                           [0, 1, 0]], dtype=np.uint8)
kernel_miss_2_1 = np.array([[0, 1, 1],
                            [0, 0, 1],
                            [0, 0, 0]], dtype=np.uint8)
kernel_hit_2_2 = np.array([[0, 1, 0],
                           [1, 1, 0],
                           [0, 0, 0]], dtype=np.uint8)
kernel_miss_2_2 = np.array([[0, 0, 0],
                            [0, 0, 1],
                            [0, 1, 1]], dtype=np.uint8)
kernel_hit_2_3 = np.array([[0, 1, 0],
                           [0, 1, 1],
                           [0, 0, 0]], dtype=np.uint8)
kernel_miss_2_3 = np.array([[0, 0, 0],
                            [1, 0, 0],
                            [1, 1, 0]], dtype=np.uint8)
kernel_hit_2_4 = np.array([[0, 0, 0],
                           [0, 1, 1],
                           [0, 1, 0]], dtype=np.uint8)
kernel_miss_2_4 = np.array([[1, 1, 0],
                            [1, 0, 0],
                            [0, 0, 0]], dtype=np.uint8)
for i in range(10):
